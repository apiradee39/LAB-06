...
นางสาวอภิรดี   ช่างเก็บ  57030243
#ใบงานที่ 6
...
![](https://raw.githubusercontent.com/apiradee39/LAB-06/5482de30f63a4e4c40fc55eb89d6da38ab55dc92/imgs/6.1.png)

###คำถาม 6.1 ถ้าพิมพ์ตัวอักษรจำนวนหลายๆ ตัวแล้วกด Enter จะได้ผลอย่างไร ทำไมจึงเป็นเช่นนั้น

พิมพได้แต่ในบรรทัดถัดไปมันจะโชวแค่ตัวอักษรตัวแรกที่กดเท่านั้นเพราะว่า char ใช้ คำสั่ง read มันทำให้ดชวอักษรแค่ตัวเดียว

###คำถาม 6.2 ในบรรทัดที่ 11 ซึ่งมีโปรแกรมเป็น ```ch = (char)Console.Read();```  นั้น ถ้าตัด ```(char)``` ออกไป จะเกิดอะไรขึ้น ให้อธิบายประกอบ

ถ้าตัดออกไปทำให้โปรแกรมติด bug เพราะไม่กำหนดชนิดของตัวแปร
...
![](https://raw.githubusercontent.com/apiradee39/LAB-06/5482de30f63a4e4c40fc55eb89d6da38ab55dc92/imgs/6.2.png)
...
![](https://raw.githubusercontent.com/apiradee39/LAB-06/5482de30f63a4e4c40fc55eb89d6da38ab55dc92/imgs/6.3.png)

###คำถาม 6.3 ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น มีวิธีการป้องกันหรือแก้ไขอย่างไร

ตอบ ตัวอักษรได้แต่เวลากด enter แล้วจะเกิดการ bug เพราะมันไม่บอกชนิดตัวแปลอักษร char ทางแก้คือ พิมพ์บอกชนิดตัวแปลลงไปด้วย
...
![](https://raw.githubusercontent.com/apiradee39/LAB-06/5482de30f63a4e4c40fc55eb89d6da38ab55dc92/imgs/6.4.png)

###คำถาม 6.4 ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น เหมือนหรือต่างจากโปรแกรมก่อนหน้านี้อย่างไร

เหมือน เพราะ ตัวอักษรได้แต่เวลากด enter แล้วจะเกิดการ bug 
...
![](https://raw.githubusercontent.com/apiradee39/LAB-06/5482de30f63a4e4c40fc55eb89d6da38ab55dc92/imgs/6.5.png)
